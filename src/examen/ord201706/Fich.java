...
/** Clase simplificada para gestionar representaciones de los datos básicos de un fichero
...
public class Fich {
	 ...
	 * @param nombre	Nombre y extensión
	 * @param fecha	Fecha de última modificación (milisegundos desde 1/1/1970)
	 * @param tamanyo	Tamaño del fichero (bytes)
	 */
