...
public class TablaDatos implements Serializable {
	...
	public int MAX_NUM_FILAS = 1000;   // Tamaño máximo de datos (filas)
	public int MAX_NUM_COLUMNAS = 100; // Tamaño máximo de datos (columnas)
	private HashSet<RefCelda> celdasSels; // Conjunto de celdas seleccionadas
	
	/** Construye una nueva tabla de datos miniexcel
	 * @param filas	Número de filas de la tabla (entre 1 y MAX_NUM_FILAS)
	 * @param columnas Número de columnas de la tabla (entre 1 y MAX_NUM_FILAS)
	 ...
	 * @return	Valor de la celda indicada, null si no está inicializada
	...
	/** Vacía todos los datos de la tabla, respetando su tamaño
	 */
	public void clear() {
	 ...
	 * @param col	Número de la columna a recuperar
	...
	/** Devuelve la información de si la celda está seleccionada
	 * @param refCelda	Referencia de la celda
	 * @return	true si la celda está seleccionada, false en caso contrario
	 */
    ...
    public void leeDeFichero( File fEntrada ) {
	    try {
	    	...
	    	while (scanner.hasNextLine()) {
	    		...
	    		// La línea tiene que tener fila - tab - columna - tab - valor
