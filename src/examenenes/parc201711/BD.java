...
/** Clase de gesti�n de base de datos del examen de plataformas UD
 * Funciona con un hilo propio para no interrumpir el tiempo de ejecuci�n del juego
...
public class BD {
	...
	/** A�ade una tecla pulsada a la tabla abierta de BD, usando la sentencia INSERT de SQL
	...
	/** A�ade una pulsaci�n o suelta de tecla a la tabla abierta de BD, usando la sentencia INSERT de SQL
	 * @param st	Sentencia ya abierta de Base de Datos (con la estructura de tabla correspondiente)
	 * @param tecla	Tecla que se pulsa
	 * @param pulsada	true si es una pulsaci�n, false si es una suelta
