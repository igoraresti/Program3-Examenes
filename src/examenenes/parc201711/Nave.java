...
public class Nave extends ObjetoMovil {
	...
	private double tamanyo;  // Tama�o en pixels de la nave
	private double giro;     // �ngulo de giro en radianes
	private double modulo;   // M�dulo de la velocidad
	protected transient Point2D[] puntos;   // Puntos del tri�ngulo que se dibuja
	
	/** Constructor de nave con datos
	 * @param x	Coordenada x del centro de la nave
	 * @param y	Coordenada y del centro de la nave
	 * @param tamanyo	Tama�o de la nave (en pixels)
	...
	/** Constructor de nave con datos m�nimos, suponiendo color azul y sin velocidad
	 * @param x	Coordenada x del centro de la nave
	 * @param y	Coordenada y del centro de la nave
	 * @param tamanyo	Tama�o de la nave (en pixels)
	 */
	...
	/** Pone el giro de la nave en una direcci�n determinada
	...
	public void gira( double angulo ) {
		super.gira( angulo );
		// giro += angulo;   // Lo hace el c�digo de setVelocidad
		calculosGeometria( false );
	}
	...
	// M�todos redefinidos para tener calculado siempre el giro y los puntos del tri�ngulo en funci�n
	// de la posici�n y la velocidad
	@Override
	...
	/** Calcula el volumen de la nave partiendo de su informaci�n de tama�o (altura del cono)
	...
	/** Calcula el �rea de la nave partiendo de su informaci�n de tama�o (altura del tri�ngulo)
	...
	public void dibuja( VentanaGrafica v ) {
		...
		// M�todos auxiliares de geometr�a de la forma de las naves
	
		private void calculosGeometria( boolean cambiarTambienElGiro ) {
			// Recalcular la geometr�a polar y si procede, ajustar el giro a la direcci�n de marcha
			...
			// Calcular la geometr�a de la nave en funci�n del giro
			double radio = tamanyo / Math.sqrt(3.0);
	...
	public void corrigeChoqueVertical( VentanaGrafica v, boolean dibujar ) {
		// Simplificado... se podr�a calcular con mejor precisi�n para que cambiara la velocidad
	 ...
	 * @return	Devuelve null si no chocan, un vector con forma de punto indicando el �ngulo y amplitud del choque sobre la nave en curso
	 */
	@Override
	 ...
	 * @return	true si el punto est� dentro de la nave, false en caso contrario
	 */
	@Override
